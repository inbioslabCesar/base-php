...
<div class="container my-5 panel-shell">
    ...
    <div class="card panel-actions-card p-4">
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-md-4 d-grid">
                <a href="dashboard.php?vista=cotizaciones_empresas" class="btn btn-success panel-action-btn">
                    <i class="bi bi-file-earmark-text"></i> Ver cotizaciones
                </a>
            </div>
            <div class="col-12 col-md-4 d-grid">
                <a href="dashboard.php?vista=clientes_empresa" class="btn btn-info panel-action-btn">
