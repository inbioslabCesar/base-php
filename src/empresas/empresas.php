...
<div class="container-fluid mt-4">
    ...
    <div class="header-section mb-3">
        <div class="p-3">
            <h3 class="mb-0 text-white fs-3 fw-bold">Lista de Empresas</h3>
        </div>
    </div>
        ...
        <table id="tabla-empresas" class="table table-bordered table-striped" style="width:100%; min-width:1200px;">
            <thead class="text-white">
                <tr>
                    ...
                    <th class="fw-semibold">Razón Social</th>
                    <th class="fw-semibold">Nombre Comercial</th>
                    <th class="fw-semibold">Dirección</th>
                    <th class="fw-semibold">Teléfono</th>
                    <th class="fw-semibold">Email</th>
                    <th class="fw-semibold">Representante</th>
                    <th class="fw-semibold">Convenio</th>
