...
<div class="container my-5">
    ...
    <div class="card shadow p-4">
        <div class="row g-3">
            ...
            <div class="col-12 col-md-4 d-grid">
                <a href="dashboard.php?vista=cotizaciones_convenios" class="btn btn-success btn-lg mb-2">
                    <i class="bi bi-file-earmark-text"></i> Ver cotizaciones
                </a>
            </div>
            <div class="col-12 col-md-4 d-grid">
                <a href="dashboard.php?vista=clientes_convenio" class="btn btn-info btn-lg mb-2">
