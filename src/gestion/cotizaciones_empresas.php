...
<?php else: ?>
<tr>
    <td colspan="9" class="text-center">No hay cotizaciones registradas para la empresa.</td>
</tr>
<?php endif; ?>
</tbody>
<tfoot>
    <tr>
        ...
        <th></th>
        <th></th>
        <th><?= htmlspecialchars(money_format_local($totalPagadoEmpresa, $currencyCfg)) ?></th>
        <th><?= htmlspecialchars(money_format_local($saldoEmpresa, $currencyCfg)) ?></th>
        <th></th>
        <th></th>
    </tr>
</tfoot>
