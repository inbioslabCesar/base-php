...
$acciones = [
    ...
    'editar_formato' => __DIR__ . '/examenes/editar_formato.php'
];
...
$vistas = [
    ...
    'format' => __DIR__ . '/examenes/format.php',
    'vista_editar_formato' => __DIR__ . '/examenes/vista_editar_formato.php'
];
